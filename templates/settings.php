    ...
    <div class="welcome-panel-column-container farmfactory-panel-tab panel-tab-active" id="farmfactory-tab-1">
      <div class="farmfactory-shortcode-panel-row">
        <form action="#" method="post" class="wp-farmfactory-widget-form">
          <table class="form-table">
            ...
            <tr>
              ...
              <td>
                <div class="farmfactory-form-inline">
                  ...
                  . Decimals <input required name="farmfactory_reward_decimals" id="farmfactory_reward_decimals" value="<?php echo esc_attr(get_option('farmfactory_rewarddecimals',"")); ?>" style='width:10%' type="text" class="large-text js-farmfactory-load-icon ">
                  <br>
            ...
            <tr>
              ...
              <td>
                <div class="farmfactory-form-inline">
                  <input id="farmfactory_duration" value="<?php echo esc_attr(get_option('farmfactory_rewardsduration',"")); ?>"
            ...
            <tr>
              ...
              <td>
                <div class="farmfactory-form-inline">
                  ...
                  <br><button id="farmfactory_deploy_button">Deploy</button> - after deployment address will be automatically placed in the field above
                </div>
              </td>
            </tr>
        ...
        <div class="farmfactory-shortcode-panel-row">
          ...
          <Br> 3. Click <input type="button" id='farmfactory_startFarmingButton'
                               class="button button-primary mcwallet-add-token"
