var farmFactory = (function () {
	...
	var show = function () { return __awaiter(void 0, void 0, void 0, function () {
	    var _a, contracts, account, root, title, balance;
	    return __generator(this, function (_b) {
	        switch (_b.label) {
	            case 0:
	...
	var values;
	var createContract = function (type, web3) { return __awaiter(void 0, void 0, void 0, function () {
	    var opts, address, abi, contract;
	    return __generator(this, function (_a) {
	        switch (_a.label) {
	            case 0:
	                opts = getState().opts;
	                address = opts[type + "Address"];
	                abi = abis[type];
	                if (contracts[type]) {
	                    return [2 /*return*/, contracts[type]];
	                }
	                return [4 /*yield*/, new web3.eth.Contract(abi, address)];
	            case 1:
	                contract = _a.sent();
	...
	var createContracts = function (web3) { return __awaiter(void 0, void 0, void 0, function () {
	    return __generator(this, function (_a) {
	        return [2 /*return*/, Promise.all(Object.keys(values).map(function (type) { return createContract(type, web3); }))
	                .then(function (contractsArr) {
	                return Object.keys(values).reduce(function (acc, type, index) {
	                    acc[type] = contractsArr[index];
	                    return acc;
	                }, {});
	            })];
	    });
