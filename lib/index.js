var farmFactory = (function () {
	...
	var init = function () { return __awaiter(void 0, void 0, void 0, function () {
	    var _a, opts, contracts, root, web3, farm, farmingFinishDate, err_1, finishDate;
	    return __generator(this, function (_b) {
	        switch (_b.label) {
	            case 0:
	                ...
	                web3 = new Web3(constants.networks[opts.networkName]);
	            ...
	            case 2:
	                _b.trys.push([2, 4, , 5]);
	                return [4 /*yield*/, contracts.farm.methods.periodFinish().call()];
	            case 3:
