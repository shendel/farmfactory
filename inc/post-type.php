...
function farmfactory_post_type() {
	...
	$labels = array(
		'name'                  => esc_html__( 'Farm Factory', 'farmfactory' ),
		'singular_name'         => esc_html__( 'Farm Factory', 'farmfactory' ),
		'menu_name'             => esc_html__( 'Farm Factory', 'farmfactory' ),
		'name_admin_bar'        => esc_html__( 'Farm Factory', 'farmfactory' ),
		'all_items'             => esc_html__( 'All Farm Factories', 'farmfactory' ),
		'add_new_item'          => esc_html__( 'Add New Farm Factory', 'farmfactory' ),
		'add_new'               => esc_html__( 'Add New', 'farmfactory' ),
		'new_item'              => esc_html__( 'New Farm Factory', 'farmfactory' ),
		'edit_item'             => esc_html__( 'Edit Farm Factory', 'farmfactory' ),
		'update_item'           => esc_html__( 'Update Farm Factory', 'farmfactory' ),
		'search_items'          => esc_html__( 'Search Farm Factory', 'farmfactory' ),
