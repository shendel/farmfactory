export default {
  ids: {
    ...
    mainPage: {
      balance: 'farmfactory-main-page-balance',
      rewardPerToken: 'farmfactory-main-page-reward-per-token',
      rewardsTimeLeft: 'farmfactory-main-page-rewards-time-left',
    },
    farmingPage: {
      ...
      approveButton: 'farmfactory-farming-page-approve-button',
      depositButton: 'farmfactory-farming-page-deposit-button',
      withdrawButton: 'farmfactory-farming-page-withdraw-button',
    },
    infoModal: {
